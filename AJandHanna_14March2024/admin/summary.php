...
<div class="panel panel-primary">
    <div class="panel-heading">
        <div class="panel-title">
            <b><i class="fa fa-file"></i>&nbsp;Summary</b>
            <div class="input-group pull-right">
                <button type="button" class="btn btn-xs btn-default" onclick="printClick('confirmed');"><i class="fa fa-check"></i>&nbsp;Print Confirmed Guest</button>&nbsp;
                <button type="button" class="btn btn-xs btn-default" onclick="printClick('all');"><i class="fa fa-users"></i>&nbsp;Print All Guest</button>
            </div>
        </div>
    </div>
...
<script>
    ...
    function printClick(report)
    {
        if (report == 'confirmed'){
            window.open("printsummary.php?p=confirmed",'_blank');
        }
        else if (report == 'all'){
            window.open("printsummary.php?p=all",'_blank');
        }
    }
</script>
