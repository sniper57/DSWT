...
?>
 ...
 <form id="brideForm" method="post" enctype="multipart/form-data">
<div class="panel panel-primary">
    <div class="panel-heading">
        <div class="panel-title">
            <div class="row">
                <div class="col-md-6">
                    <b><i class="fa fa-female"></i>&nbsp;Bride's Information</b>
                </div>
                <div class="col-md-6">
                    <button form="brideForm" type="submit" id="btnSubmit" name="btnSubmit" class="btn btn-sm btn-default pull-right"><i class="fa fa-save"></i>&nbsp;Save</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="panel-body">
            ...
            <div class="form-group" style="display:flex">
                <img id="image" src="<?php echo $brideinfo[0]['image']!= '' ? 'data:image/jpg;charset=utf8;base64,'.base64_encode($brideinfo[0]['image']) : 'img/profile-icon.png' ?>" style="width:150px;height:150px;border:1px solid gray">
            ...
            <div class="form-group">
                ...
                <input  type="hidden" name="id" id="id" value = "<?php echo ($brideinfo== null) ? "" : ($brideinfo[0]['id'] != "" ? $brideinfo[0]['id'] :  "")?>"/>
                <input class="form-control" type="text" name="fname" id="fname" placeholder="Firstname" 
                value = "<?php echo ($brideinfo== null) ? "" : ($brideinfo[0]['fname'] != "" ? $brideinfo[0]['fname'] :  "")?>"/>
            </div>

            <div class="form-group">
                <label for="mname">Middle Name:</label>
                <input class="form-control" type="text" name="mname" id="mname" placeholder="Middle Name" 
                value = "<?php echo ($brideinfo== null) ? "" : ($brideinfo[0]['mname'] != "" ? $brideinfo[0]['mname'] :  "")?>"/>
            </div>

            <div class="form-group">
                <label for="lname">Last Name:</label>
                <input class="form-control" type="text" name="lname" id="lname" placeholder="Last Name"
                value = "<?php echo ($brideinfo== null) ? "" : ($brideinfo[0]['lname'] != "" ? $brideinfo[0]['lname'] :  "")?>"/>
            </div>

            <div class="form-group">
                <label for="prefix">Prefix (Optional)</label>
                <input class="form-control" type="text" name="prefix" id="prefix" placeholder="Prefix"
                value = "<?php echo ($brideinfo== null) ? "" : ($brideinfo[0]['prefix'] != "" ? $brideinfo[0]['prefix'] :  "")?>"/>
            </div>
            <div class="form-group">
                <label for="contactnumber">Contact Number</label>
                <input class="form-control" type="text" name="contactnumber" id="contactnumber" placeholder="Contact Number"
                value = "<?php echo ($brideinfo== null) ? "" : ($brideinfo[0]['contactnumber'] != "" ? $brideinfo[0]['contactnumber'] :  "")?>"/>
            </div>

            <div class="form-group">
                <label for="nickname">Nickname</label>
                <input class="form-control" type="text" name="nickname" id="nickname" placeholder="Nickname"
                value = "<?php echo ($brideinfo== null) ? "" : ($brideinfo[0]['nickname'] != "" ? $brideinfo[0]['nickname'] :  "")?>"/>
            </div>

            <div class="form-group">
                <label for="favquote">Favorite Quote About Life</label>
                <textarea class="form-control" name="favquote" id="favquote" placeholder="Favorite Quote About Life"><?php echo ($brideinfo== null) ? "" : ($brideinfo[0]['favquote'] != "" ? $brideinfo[0]['favquote'] :  "")?></textarea>
            </div>

            <div class="form-group">
                <label for="description">Description About Yourself </label>
                <textarea class="form-control" name="description" id="description" placeholder="Favorite Quote About Life"><?php echo ($brideinfo== null) ? "" : ($brideinfo[0]['description'] != "" ? $brideinfo[0]['description'] :  "")?></textarea>
            </div>
...
<?php
    ...
    if(ISSET($_POST['btnSubmit']))
    {
        ...
        if($brideinfo == null)
        {
            ...
            if($result['data']) { 
                echo (popUp("success","Saved", "(" . $result['count'] . ") Record Saved!","brideinformation.php"));
            } else {  
        ...
        else
        {
            ...
            if($result['data']) { 
                echo (popUp("success","Updated", "Record Updated!","brideinformation.php"));
            } else {  
